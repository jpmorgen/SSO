; $Id: sso_oploterr.pro,v 1.1 2015/03/03 20:14:14 jpmorgen Exp $

PRO sso_oploterr, X, Y, ERR, PSYM, linestyle=linestyle
;
;+
; NAME:
;	SSO_OPLOTERR
...
; Sat May 29 21:39:53 2004  jpmorgen
; made linestyle keyword
...
NP = N_PARAMS(0)
IF NP LT 2 THEN $
  message, 'Must be called with 2-4 parameters: [ X ,]  Y , ERR  [, PSYM ], linestyle=linestyle' $
